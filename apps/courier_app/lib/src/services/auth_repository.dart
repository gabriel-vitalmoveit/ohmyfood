...
class AuthRepository {
  ...
  static const String _courierIdKey = 'auth_courier_id';
  ...
  Future<void> saveUserData(Map<String, dynamic> userData) async {
    ...
    if (userData['courierId'] != null) {
      await prefs.setString(_courierIdKey, userData['courierId'] as String);
    }
  }
  ...
  Future<String?> getCourierId() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_courierIdKey);
  }
